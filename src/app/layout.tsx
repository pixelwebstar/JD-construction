    ...
    >
      <body className="min-h-full flex flex-col font-sans bg-slate-white text-steel-slate">
        ...
        <div className="relative flex-grow flex flex-col w-full">
          ...
          <div className="absolute top-0 left-0 w-full h-[calc(100vh-80px)] overflow-hidden pointer-events-none z-0 bg-slate-950">
            <video
              autoPlay
              loop
              muted
          ...
          <main className="flex-grow flex flex-col w-full relative z-10">{children}</main>
        </div>
